...
export function saveFaceDescriptor(faceId, descriptor, metadata = {}) {
    ...
    if (existingIndex !== -1) {
        ...
        const faceData = {
            ...
            metadata,
            thumbnailDriveId: metadata.thumbnailDriveId || existingFace.thumbnailDriveId, // Preserve thumbnail ID
        ...
        const faceData = {
            ...
            metadata,
            thumbnailDriveId: metadata.thumbnailDriveId, // Store thumbnail Drive ID
            lastSeen: new Date().toISOString(),
            photoCount: 1,
            sampleCount: 1
        };
