...
export function savePhoto(photo) {
    ...
    try {
        ...
        console.log(`[Photo Storage] Successfully wrote to photos.json`);
        return photo;
    } catch (writeError) {
        console.error('[Photo Storage] Failed to write to photos.json:', writeError);
        throw writeError;
    }
}
...
export function updatePhoto(photoId, updates) {
    ...
    try {
        ...
        console.error('[Photo Storage] Failed to update photo:', writeError);
        throw writeError;
    }
}
