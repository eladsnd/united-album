...
export class AppSettingsRepository extends BaseRepository {
  ...
  async updateSettings(updates) {
    try {
      console.log('[AppSettingsRepository] Attempting upsert with updates:', updates);
      ...
      console.log(`[AppSettingsRepository] Upsert successful:`, updated);
      return updated;
    } catch (error) {
      console.error('[AppSettingsRepository] Upsert failed with error:', error);
      console.error('[AppSettingsRepository] Error message:', error.message);
      console.error('[AppSettingsRepository] Error code:', error.code);
      console.error('[AppSettingsRepository] Updates that failed:', updates);
      throw error;
    }
  }
